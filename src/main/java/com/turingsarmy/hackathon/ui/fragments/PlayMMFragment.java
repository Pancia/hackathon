...
public class PlayMMFragment extends Fragment {
    ...
    private void setupGame(View v, String home){
        ...
        red0 = (Button) v.findViewById(R.id.activity_mm_red0);
        blu0 = (Button) v.findViewById(R.id.activity_mm_blu0);
        grn0 = (Button) v.findViewById(R.id.activity_mm_grn0);

        red1 = (Button) v.findViewById(R.id.activity_mm_red1);
        blu1 = (Button) v.findViewById(R.id.activity_mm_blu1);
        grn1 = (Button) v.findViewById(R.id.activity_mm_grn1);

        red2 = (Button) v.findViewById(R.id.activity_mm_red2);
        blu2 = (Button) v.findViewById(R.id.activity_mm_blu2);
        grn2 = (Button) v.findViewById(R.id.activity_mm_grn2);

        red3 = (Button) v.findViewById(R.id.activity_mm_red3);
        blu3 = (Button) v.findViewById(R.id.activity_mm_blu3);
        grn3 = (Button) v.findViewById(R.id.activity_mm_grn3);

        red4 = (Button) v.findViewById(R.id.activity_mm_red4);
        blu4 = (Button) v.findViewById(R.id.activity_mm_blu4);
        grn4 = (Button) v.findViewById(R.id.activity_mm_grn4);

        red5 = (Button) v.findViewById(R.id.activity_mm_red5);
        blu5 = (Button) v.findViewById(R.id.activity_mm_blu5);
        grn5 = (Button) v.findViewById(R.id.activity_mm_grn5);

        red6 = (Button) v.findViewById(R.id.activity_mm_red6);
        blu6 = (Button) v.findViewById(R.id.activity_mm_blu6);
        grn6 = (Button) v.findViewById(R.id.activity_mm_grn6);

        red7 = (Button) v.findViewById(R.id.activity_mm_red7);
        blu7 = (Button) v.findViewById(R.id.activity_mm_blu7);
        grn7 = (Button) v.findViewById(R.id.activity_mm_grn7);

        red8 = (Button) v.findViewById(R.id.activity_mm_red8);
        blu8 = (Button) v.findViewById(R.id.activity_mm_blu8);
        grn8 = (Button) v.findViewById(R.id.activity_mm_grn8);

        red9 = (Button) v.findViewById(R.id.activity_mm_red9);
        blu9 = (Button) v.findViewById(R.id.activity_mm_blu9);
        grn9 = (Button) v.findViewById(R.id.activity_mm_grn9);

        ges0 = (TextView) v.findViewById(R.id.activity_mm_ges0);
        ges1 = (TextView) v.findViewById(R.id.activity_mm_ges1);
        ges2 = (TextView) v.findViewById(R.id.activity_mm_ges2);
        ges3 = (TextView) v.findViewById(R.id.activity_mm_ges3);
        ges4 = (TextView) v.findViewById(R.id.activity_mm_ges4);
        ges5 = (TextView) v.findViewById(R.id.activity_mm_ges5);
        ges6 = (TextView) v.findViewById(R.id.activity_mm_ges6);
        ges7 = (TextView) v.findViewById(R.id.activity_mm_ges7);
        ges8 = (TextView) v.findViewById(R.id.activity_mm_ges8);
        ges9 = (TextView) v.findViewById(R.id.activity_mm_ges9);
    ...
    public void checkAns(final TextView tv){
        ...
        if(numC == solution.length){
            Toast.makeText(getActivity(), "Good job! You won resources for your college!", Toast.LENGTH_SHORT).show();
    ...
    private void createToast(final String string, final int length){
        ...
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(getActivity(), string, length).show();
